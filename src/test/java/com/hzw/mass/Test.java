...
public class Test {
    ...
    public void test12(){
        ...
        System.out.println(new Gson().toJson(JdbcUtil.getErrorTypeCollect(93)));
    }

    @org.junit.Test
    public void test13(){

        System.out.println(JdbcUtil.getSendedCount(114));
    }
    ...
    public void test14(){
        ...
        App.ACCESS_TOKEN = WxUtils.getAccessToken();
        List<Fail> failList = JdbcUtil.getFailExceptCodeIsZero(114);
        String textPlan = JdbcUtil.getTextPlanById(114);
